	 ...
	 color: rgb(248,48,156);
        ...
        <script type="text/javascript">
        	function sendIt(){
        		...
        		f.action = "<%=cp %>/reserve/reserve_hotel.do?userId=${sessionScope.LoginInfo.dto.userId }";
        		f.submit();
        	}
        	function cancel(){
        		var f = document.myForm;
        		f.action = "<%=cp %>/reserve/reserve_user_cancel.do";
        		f.submit();
        	}
        ...
        <div id="wrapper">
            ...
            <div id="content">
                ...
                <h3 class="join_title"><label for="name">방선택</label></h3>
                           <span class="box">
                               <select name="ReserveRoom" class="sel">
                                   <option value="${dto.getReserveRoom() }" selected="selected">${dto.reserveRoom }</option>
                               </select>
                           </span>
                       </div>
                ...
                <div>
                  ...
                  <!-- MOBILE -->
                <div>
                    <h3 class="join_title"><label for="phoneNo">예약자 휴대전화</label></h3>
                    <span class="box int_mobile">
