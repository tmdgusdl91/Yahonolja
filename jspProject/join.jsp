...
<html lnag="ko">
    ...
    <body>
    	<form action="<%=cp %>/user/join_ok.do" method="post" name="myForm">
        <!-- header -->
        <div id="header">
        ...
        <div id="wrapper">
            ...
            <div id="content">				
                <!-- GENDER -->
                <div>
                    <h3 class="join_title"><label for="gender">구분</label></h3>
                    <span class="box gender_code">
                        <select name="userType" class="sel">
                ...
                <div>
                    ...
                    <span class="box int_id">
                        <input type="text" name="userId" class="int" maxlength="20">
                    </span>
               ...
               <div>
                    ...
                    <span class="box int_pass">
                        <input type="password" name="userPw1" class="int" maxlength="20">                     
                    </span>
                </div>
                ...
                <div>
                    ...
                    <span class="box int_pass_check">
                        <input type="password" name="userPw2" class="int" maxlength="20">
                    </span>
                </div>
                ...
                <div>
                    ...
                    <span class="box int_name">
                        <input type="text" name="userName" class="int" maxlength="20">
                    </span>
                    <span class="error_next_box"></span>
                </div>
                ...
                <div>
                    ...
                    <div id="bir_wrap">
                        ...
                        <div id="bir_yy">
                            <span class="box">
                                <input type="text" name="userBy" class="int" maxlength="4" placeholder="년(4자)">
                            </span>
                        </div>
                        ...
                        <div id="bir_dd">
                            <span class="box">
                                <input type="text" name="userBd" class="int" maxlength="2" placeholder="일">
                            </span>
                        </div>
                ...
                <div>
                    ...
                    <span class="box gender_code">
                        <select name="userGender" class="sel">
                ...
                <div>
                    ...
                    <span class="box int_email">
                        <input type="text" name="userEmail" class="int" maxlength="100" placeholder="선택입력">
                    </span>
                ...
                <div>
                    ...
                    <span class="box int_mobile">
                        <input type="tel" name="userPhone" class="int" maxlength="16" placeholder="전화번호 입력">
                    </span>
                    <span class="error_next_box"></span>    
                </div>
